...
def my_args():
    ...
    # 指定要可视化的路径
    parser.add_argument("--path", default="0x3f", type=str, nargs ='?', required=True,
                        help=f"path")
...
def visual(data):
    ...
    x_axis_data = [func_name for func_name, _, _ in data]  # x轴标签
    y_axis_data1 = [miss_rate for _, miss_rate, _ in data]  # y轴标签：miss 率
    y_axis_data2 = [hit_rate for _, _, hit_rate in data]  # y轴标签：hit 率
